...
description: How ia-ide organizes work around projects and repositories, with multi-repo support and isolated worktrees.
---
...
A **project** is the top-level organizational unit in ia-ide. It groups together:
...
```
ia-ide/run-a1b2c3d4-api       # worktree for the "api" repo
ia-ide/run-a1b2c3d4-frontend  # worktree for the "frontend" repo
```
...
<Aside type="tip">
If you see "worktree not found" errors, make sure the repo has at least one commit. ia-ide needs a base commit to create the worktree from.
</Aside>
