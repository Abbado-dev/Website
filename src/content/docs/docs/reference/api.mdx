---
title: API Reference
description: Complete REST API reference for Abbado — projects, agents, runs, events, changes, branches, settings, and WebSocket terminal.
---

import { Aside } from '@astrojs/starlight/components';

All endpoints are prefixed with `/api/`. The server runs on `http://127.0.0.1:4320` by default.
